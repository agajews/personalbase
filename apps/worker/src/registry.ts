...
import { filterResultsFold, filtersFold, graphFold, papersFold } from "@nc/folds";
import {
  affiliationsReactor,
  arxivReactor,
...
export const folds: readonly Fold[] = [papersFold, filtersFold, filterResultsFold, graphFold];
